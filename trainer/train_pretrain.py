...
from model.utils import print_banner
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniWin Pretraining")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniWin-Pretrain", help="wandb项目名")
    ...
    parser.add_argument("--partial_rotary_factor", type=float, default=1.0, help="1.0=全部维度rope")
    ...
    if args.use_wandb and is_main_process():
        wandb_run_name = (
            f"MiniWin-Pretrain-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
            f"-NW-{args.n_windows}-SW-{args.sliding_window_size}"
        )
