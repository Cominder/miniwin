# 注：不建议随意重训 tokenizer；MiniWin 默认与上游词表对齐。本脚本从 minimind3 同步，仅供学习/自定义词典时参考。
# Note: Re-training the tokenizer changes vocabulary; use only if you intentionally fork the tokenizer.
import os
import json
