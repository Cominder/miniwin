...
from trainer.trainer_utils import Logger, is_main_process, lm_checkpoint, init_distributed_mode, setup_seed, SkipBatchSampler, init_model, LMForRewardModel, init_wandb_run
...
# 自定义的Critic模型，继承自 MiniWin
class CriticModel(MiniWinForCausalLM):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniWin PPO (Proximal Policy Optimization)")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniWin-PPO", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        wandb_run_name = f"MiniWin-PPO-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
