...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniWin Agent RL")
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniWin-Agent-RL", help="wandb项目名称")
    ...
    if args.use_wandb and is_main_process():
        wandb = init_wandb_run(
            args.wandb_project,
            f"Agent-RL-E{args.epochs}-B{args.batch_size}-LR{args.learning_rate}",
            ckp_data,
        )
